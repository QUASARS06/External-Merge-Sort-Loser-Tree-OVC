...
int main(int argc, char *argv[])
{
	...
	printf("------------------------------ Test 7 --------------------------------\n");
	printf("Description : All Records and the Column Values in each record is the same (see scan_type = 3 below)\n\n");
	...
	int scan_type = argMap.find("-s") != argMap.end() ? std::atoi(argMap["-s"].c_str()) : 3;
